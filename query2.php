...
<nav class="navbar navbar-expand-lg navbar-dark d-none d-lg-block" style="z-index: 2000;">
      <div class="container-fluid">
        ...
        <div id="column2">
                 <a class="nav-link" rel="nofollow" href = "renting.php" target="_blank">rent a car</a>
        </div>
        <div id="column3"> <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        queries</a>
...
$query="SELECT bill_date,bill_id,total_amount,bill_status FROM billing_amt WHERE total_amount > ALL( SELECT AVG(total_amount) FROM billing_amt);";
...
echo "<b>"."IN clause"."</b><br>";
print("Print bill date,bill id, total amount where the avg total is greater than total amount");
print("SELECT bill_date,bill_id,total_amount,bill_status FROM billing_amt WHERE total_amount > ALL( SELECT AVG(total_amount) FROM billing_amt);");
         print("<br><br>");
